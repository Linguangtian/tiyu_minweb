            ...
            <table class="table table-bordered bg-white">
                    ...
                    <td colspan="5">
                        ...
                        <?php if ($order_item['is_send'] == 1) : ?>
                            <span class="mr-1">
                                    <?php if ($order_item['is_confirm'] == 1) : ?>
                                        <span class="badge " style="background:#5BD18A; ">已收货</span>
                                    <?php else : ?>
                        ...
                        <?php else: ?>
                            <?php if ($order_item['is_pay'] == 1) : ?>
                                <span class="mr-1">
                                    <?php if ($order_item['is_send'] == 1) : ?>
                                        <span class="badge " style="background: #5BD18A;">已发货</span>
                                    <?php else : ?>
                        ...
                        <span class="mr-5"><span class='titleColor'>
                            ...
                            <?php if (isset($order_item['platform']) && intval($order_item['platform']) === 0): ?>
                                <span class="badge " style="background: #5BD18A;">微信</span>
                            <?php elseif (isset($order_item['platform']) && intval($order_item['platform']) === 1): ?>
                                <span class="badge " style="background: #5BD18A;">支付宝</span>
                            <?php else: ?>
                        ...
                        <?php if ($order_item['apply_delete'] == 1) : ?>
                            <?php if ($order_item['is_delete'] == 0) : ?>
                                ...
                                <span>
                                        <a class="btn btn-sm refuse  apply-status-btn"  style="background: #FF7878;color: #FFFFFF;"
                        ...
                        <?php if ($order_item['refund']) : ?>
                            <span class="mr-1 titleColor">
                                ...
                                <?php elseif ($order_item['refund'] == 1) : ?>
                                    <span class="badge " style="background: #5BD18A;">同意并已退款</span>
                                <?php elseif ($order_item['refund'] == 2) : ?>
                                    <span class="badge " style="background: #5BD18A;">已同意换货</span>
                ...
                <tr>
                            ...
                            <div class="goods-item" flex="dir:left box:first">
                                ...
                                <div class="goods-info">
                                    ...
                                    <div class="mt-1">
                                        ...
                                        <span class="fs-sm">数量：
                                            <span style="color: #ff7878;"><?= $goods_item['num'] . $goods_item['unit'] ?></span>
                                        </span>
                                    </div>
                                    <div>
                                        <span class="fs-sm">小计：
                                            <span class=" mr-4" style="color: #ff7878;"><?= $goods_item['total_price'] ?>元</span>
                                        </span>
                    ...
                    <td class="order-tab-2">
                        <div class='titleColor'>总金额：<span style="color:#5b9bd1;"><?= $order_item['total_price'] ?></span>元
                            <?php if ($order_item['express_price_1']) : ?>
                                (含运费：<span style="color:#5BD18A;"><?= $order_item['express_price_1'] ?></span>元)</span>
                                <span class="text-danger">(包邮，运费减免)</span>
                            <?php else : ?>
                                (运费：<span style="color:#5BD18A;"><?= $order_item['express_price'] ?></span>元)</span>
                            <?php endif; ?>
                        </div>
                        <?php if ($order_item['user_coupon_id']) : ?>
                            <div class='titleColor'>优惠券：
                                <span style="color:#5b9bd1;"><?= $order_item['coupon_sub_price'] ?></span>元
                            </div>
                        <?php endif; ?>
                        <?php if ($order_item['before_update_price']) : ?>
                            <?php if ($order_item['pay_price'] > $order_item['before_update_price']) : ?>
                                <div class='titleColor'>后台加价：
                                    <span style="color:#5b9bd1;"><?= $order_item['pay_price'] - $order_item['before_update_price'] ?></span>元
                                </div>
                            <?php else : ?>
                                <div class='titleColor'>后台优惠：
                                    <span style="color:#5b9bd1;"><?= $order_item['before_update_price'] - $order_item['pay_price'] ?></span>元
                                </div>
                            <?php endif; ?>
                        <?php endif; ?>
                        <?php if ($order_item['integral'] && $order_item['integral']['forehead_integral']) : ?>
                            <span class='titleColor'>使用<?= $order_item['integral']['forehead_integral'] ?>积分抵扣：
                                    <span style="color:#5b9bd1;"><?= $order_item['integral']['forehead'] ?></span>元
                                </span>
                        <?php endif; ?>
...
<!--                            <div class='titleColor'>会员折扣：<span style="color:red;">--><?//= $order_item['discount'] ?><!--</span>折</div>-->
                    ...
                    <td class="order-tab-3">
                        <div><span style="color:#5B9BD1;"><?= $order_item['pay_price'] ?></span>元</div>
                    </td>
                    <td class="order-tab-4">
                        ...
                        <?php if ($order_item['pay_type'] == 2) : ?>
                            <div>
                                支付方式：
                                <span class="badge " style="background: #5BD18A;">货到付款</span>
                            </div>
                        <?php elseif ($order_item['pay_type'] == 3) : ?>
                            <div>
                                支付方式：
                                <span class="badge " style="background: #5BD18A;">余额支付</span>
                            </div>
                        <?php else : ?>
                            <div>
                                支付方式：
                                <span class="badge" style="background: #5BD18A;">线上支付</span>
                            </div>
                        <?php endif; ?>
                        ...
                        <div>
                            ...
                            <?php if ($order_item['is_offline'] == 1) : ?>
                                <span class="badge  mt-1" style="background:#EA9818;">到店自提</span>
                            <?php else : ?>
                                <span class="badge  mt-1" style="background:#EA9818;">快递发送</span>
                            <?php endif; ?>
                        </div>
                    ...
                    <td class="order-tab-5">
                        ...
                        <div>
                            <a class="btn btn-sm send-btn mt-2" style="background: #5B9BD1; color: #FFFFFF;" href="javascript:"
                            ...
                            <a class="btn btn-smclerk-btn mt-2"  style="background: #5B9BD1; color: #FFFFFF;" href="javascript:"
                               data-order-id="<?= $order_item['id'] ?>">核销</a>
                        </div>
                    <?php endif; ?>
                        <div>
                            <?php if ($order_item['is_recycle'] == 1) : ?>
                                <a class="btn btn-sm mt-2 del" href="javascript:" style="background: #FF7878; color: #FFFFFF"
                                   data-url="<?= $urlManager->createUrl([$urlStr . '/delete', 'order_id' => $order_item['id']]) ?>"
                                   data-content="是否删除">删除订单</a>
                            <?php endif; ?>
                        </div>
                        <div>
                            <a class="btn btn-sm  mt-2" style="background: #5B9BD1; color: #FFFFFF;"
                               href="<?= $urlManager->createUrl([$urlStr . '/detail', 'order_id' => $order_item['id']]) ?>">详情</a>
                            <a class="btn btn-sm  mt-2 about"  style="background: #5B9BD1; color: #FFFFFF;"
                        ...
                        <?php if ($order_item['pay_type'] == 2 && $order_item['is_send'] == 1 && $order_item['is_confirm'] != 1) : ?>
                            <div>
                                <a href="javascript:" class="btn btn-sm  mt-2 del" style="background: #5B9BD1; color: #FFFFFF;"
                        ...
                        <?php if ($order_item['is_recycle'] == 1) : ?>
                            <div>
                                <a class="btn btn-sm  del mt-2" href="javascript:" style="background: #5B9BD1; color: #FFFFFF;"
                                   data-url="<?= $urlManager->createUrl([$urlStr . '/edit', 'order_id' => $order_item['id'], 'is_recycle' => 0]) ?>"
                                   data-content="是否移出回收站">移出回收站</a>
                            </div>
                        <?php else : ?>
                            <div>
                                <a class="btn btn-sm  del mt-2" href="javascript:"  style="background: #FF7878;color: #FFFFFF;"
                        ...
                        <div>
                            <?php if ($order_item['is_offline'] == 0) : ?>
                                ...
                                <?php if ($order_item['is_send'] == 0) : ?>
                                    <a class="btn btn-sm edit-address" style="background: #5B9BD1; color: #FFFFFF;"
                                       data-index="<?= $k ?>"
