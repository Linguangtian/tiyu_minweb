...
<div class="panel">
    ...
    <div class="panel-body">
        <form method="post" class="auto-form">
            ...
            <div  style="color: red;">入驻商审核成功通知</div>
            <div class="text-muted fs-sm">例如：模板内容:审核成功，请登录小程序查看</div>
            <div class="form-group row">
                <div class="form-group-label col-sm-2 text-right">
                    <label class="col-form-label">模板名称</label>
                </div>
                <div class="col-sm-6">
                    <input autocomplete="off" class="form-control" type="text" name="bond_success[name]"
                           value="<?= $bond_success['name'] ?>">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <input autocomplete="off" class="form-control" type="text" name="bond_success[tpl]"
                           value="<?= $bond_success['tpl'] ?>">
                </div>
            </div>
            <!--===========================商户审核通知短信====================-->


            <div  style="color: red;">入驻商审核失败通知</div>
            <div class="text-muted fs-sm">例如：审核失败，请登录小程序查看原因！</div>
            <div class="form-group row">
                <div class="form-group-label col-sm-2 text-right">
                    <label class="col-form-label">模板名称</label>
                </div>
                <div class="col-sm-6">
                    <input autocomplete="off" class="form-control" type="text" name="bond_fail[name]"
                           value="<?= $bond_fail['name'] ?>">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <input autocomplete="off" class="form-control" type="text" name="bond_fail[tpl]"
                           value="<?= $bond_fail['tpl'] ?>">
                </div>
            </div>
